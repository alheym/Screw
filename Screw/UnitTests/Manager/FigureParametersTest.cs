...
namespace Screw.UnitTests.Manager
{
    ...
    class FigureParametersTest
    {
        ...
        [TestCase(false, 270000, 50000, 2500000, 6400000, 100000, 50000, TestName = "FigureParameters, very high values (10^^4)")]
        [TestCase(false, 27000, 5000, 250000, 640000, 10000, 5000, TestName = "FigureParameters, very high values (10^^3)")]
        [TestCase(false, 2700, 5000, 25000, 64000, 1000, 5000, TestName = "FigureParameters, high values      (10^^2)")]
        [TestCase(true, 270, 50, 250, 640, 100, 50, TestName = "FigureParameters, normal values    (10)")]
        [TestCase(true, 27, 5, 25, 64, 10, 5, TestName = "FigureParameters, normal values    (1)")]
        [TestCase(true, 2.7, 0.5, 2.5, 6.4, 1.0, 0.5, TestName = "FigureParameters, very low values  (0.1)")]
        [TestCase(false, 0.27, 0.05, 0.25, 0.64, 0.10, 0.05, TestName = "FigureParameters, very low values  (0.01)")]
        [TestCase(false, 0.027, 0.005, 0.025, 0.064, 0.010, 0.005, TestName = "FigureParameters, very low values  (0.001)")]
        [TestCase(false, 0.0027, 0.0005, 0.0025, 0.0064, 0.0010, 0.0005, TestName = "FigureParameters, very low values  (0.0001)")]
