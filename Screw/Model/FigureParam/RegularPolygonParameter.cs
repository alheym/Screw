...
namespace Screw.Model.FigureParam
{
	...
	public class RegularPolygonParameter
    {
        ...
        public RegularPolygonParameter(KompasApplication kompasApp, int anglesCount, double inscribedCircleRadius, KompasPoint2D point2D)
        {
            ...
            polyParam.radius = inscribedCircleRadius;           // INscribed circle radius, / D /
        ...
        public RegularPolygonParameter(KompasApplication kompasApp, double count, double width, KompasPoint2D regPolyPoint)
        {
        }
    }
}
